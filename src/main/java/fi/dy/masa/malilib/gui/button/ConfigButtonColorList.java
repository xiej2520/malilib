...
public class ConfigButtonColorList extends ButtonGeneric
{
    ...
    {
        this.displayString = StringUtils.getClampedDisplayStringRenderlen(this.config.getColors().stream().map(Object::toString).collect(Collectors.toList()), this.width - 10, "[ ", " ]");
    }
}
